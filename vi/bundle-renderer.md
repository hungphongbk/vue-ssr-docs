...
We will discuss how to cấu hình webpack to generate the build artifacts needed by the bundle renderer in the next section, but for now let's assume we already have what we need, và this is how to create và use a bundle renderer:
